...
class ImageGallery {
    ...
    initInteractions() {
        ...
        window.addEventListener('click', () => {
            // Only allow intersection click if the container is actually interactive
            if(getComputedStyle(this.app.container).pointerEvents !== 'auto') return;
    ...
    update() {
        ...
        // Raycast for hover
        // Only raycast if the container allows pointer events
        if (getComputedStyle(this.app.container).pointerEvents === 'auto') {
